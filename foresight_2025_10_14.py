# Foresight — ADC Conjugation Literature Intelligence (Clean Full, 2025-10-15)
...
UA = "Syngene-Foresight/1.0 (contact: research@syngeneintl.com)"
...
def build_signals(df):
    ...
    full = "\n".join((titles + " " + abstracts + " " + abstracts).tolist())  # weight abstracts 2×
...
with st.sidebar:
    ...
    query = st.text_input("PubMed query", value=default_query)
